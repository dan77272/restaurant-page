            ...
            <div className="col-span-1 flex flex-col gap-10 m-auto">
              {firstHalf.map((m, index) => (
                <div key={index} className="p-2 flex gap-5">
                    <Image src={m.image} height={150} width={150} alt="image" />
                    <div className="">
                        <div className="flex justify-between pb-5 w-[300px] xl:w-full">
                        ...
                        <div className="xl:w-[500px] w-[300px] text-neutral-500 text-sm">
                          {m.description}
                        </div>
                    </div>
                </div>
